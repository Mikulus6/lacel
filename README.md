...
* python 3 built-in libraries:
  ...
  * [shutil](https://docs.python.org/3/library/shutil.html) (necessary only for `setup.py`)
  * [subprocess](https://docs.python.org/3/library/subprocess.html) (necessary only for `setup.py`)
